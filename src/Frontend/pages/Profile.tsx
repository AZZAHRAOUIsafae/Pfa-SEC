        ...
        <div className="space-y-6">
          <div className="bg-card border rounded-2xl p-8 flex flex-col items-center text-center">
            ...
            {formData.role === 'TOPOGRAPHER' && (
              <div className="mt-4 w-full flex flex-col items-center gap-1.5 bg-amber-500/5 px-4 py-3 rounded-2xl border border-amber-500/10">
                <p className="text-[9px] font-black uppercase tracking-widest text-amber-600">Note Globale</p>
                ...
                <p className="text-[10px] text-muted-foreground">
                  Basé sur {formData.reviewCount || 0} évaluations
                </p>
              </div>
            )}
